...
/**
 * Instagram — sosyal bağlantı ikonu.
 *
 * `Cerceve` KULLANMAZ: o çerçeve 48'lik kutuda 40px'lik dekoratif bölüm
 * ikonları içindir. Bu ikon bir BAĞLANTININ içinde, metin boyutunda
 * durur; rengi `currentColor` ile bağlantıdan miras alır, böylece
 * mevcut palete hiçbir yeni renk eklemez.
 *
 * Yeni paket kurulmadı; simge özgün olarak çizildi.
 */
export function IkonInstagram({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
