    ...
    <main className="pt-20 flex min-h-screen items-center justify-center bg-[#09090f] px-4 py-12 text-white">
      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-3xl font-bold">{ceviri.devirDaveti.baslik}</h1>

          <p className="mt-2 text-sm text-white/50">
            {token
              ? ceviri.devirDaveti.aciklama
              : ceviri.devirDaveti.baglantiEksik}
          </p>
        </div>
        ...
        {token ? (
          <>
            <div className="mb-5 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm">
              <p className="text-white/50">{ceviri.devirDaveti.girisYapanHesap}</p>
              ...
              <p className="mt-3 text-white/50">
                ...
                >{ceviri.kalanlar.farkliHesapGiris}</Link>
              </p>
            </div>
          ...
          <div className="space-y-5">
            <div className="rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-300">{ceviri.kalanlar.davetGecersiz}</div>
